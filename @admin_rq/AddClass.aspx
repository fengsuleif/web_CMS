<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="./MasterPage.master" CodeFile="AddClass.aspx.cs" Inherits="Admin_AddClass"  Debug="true"%>

<asp:Content ID="AddClass" ContentPlaceHolderID="Conut1" runat="server">
...
<table width="775" border="0" cellspacing="2" cellpadding="0"  align="center">
  <tr>
    <td align="center" class="Login1" height="25">添加一级分类</td>
  </tr>
  <tr>
    <td align="center" class="Login2" style="height: 26px">分类名称: <asp:TextBox ID="TextBoxFclass" runat="server"></asp:TextBox></td>
  </tr>
   <tr>
  ...
  <tr>
    <td align="center" class="Login1" height="25">添加子分类</td>
  </tr>
  <tr>
    <td align="center" class="Login2">子分类名称: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td>
  </tr>
