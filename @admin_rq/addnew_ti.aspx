<%@ Page Language="C#"  ValidateRequest="false" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="addnew_ti.aspx.cs" Inherits="_Management_ti_addnew_ti" Title="添加文章" %>
...
<script type="text/javascript">        
 ...
 <table  cellspacing="2"  class="table">
  <tr class="info" >
    <td colspan="2" height="25" >添加新闻</td>
  </tr>
 <tr>
  ...
  <tr>
   ...
   <tr>
    <td  class="Login2" width="15%">发布日期:</td>
    <td align="left" class="Login2">
        <asp:TextBox ID="ximg" runat="server"></asp:TextBox>
      </td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <td align="left" class="Login2"><asp:TextBox ID="ViewFrom" runat="server" /></td>
  </tr>
   <tr>
    <td  class="Login2" width="15%">原始作者:</td>
    <td align="left" class="Login2">
...
<td colspan="2"  class="Login1" height="25">
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="提交" class="btn btn-primary" /> 
    </td>
  </tr>
  </table>   
